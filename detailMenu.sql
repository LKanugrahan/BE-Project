...
UPDATE users
SET
    password = '$argon2id$v=19$m=65536,t=3,p=4$JJtWcUpzQQohhqGPl7QYXw$xdFFzP/Fd0DkGz6gucXGAzJ1n6drG+kUzyd1xFb7z2E'
WHERE id = 1;
...
ALTER TABLE category ADD COLUMN category_image VARCHAR;
